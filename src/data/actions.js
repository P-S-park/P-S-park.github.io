export default [
  ...
  {title: 'ГлавКонтроль', 
    html: `Сейчас, 3-го февраля, сносят две недавно устроенные спорт-площадки около 4-го пруда.
    <br>Фотографируйте и напишите, пожалуйста, 
    <a href="https://www.mos.ru/feedback/reception/?department=21375090">в Главное Контрольное управление Москвы</a>:
    <br>В ходе реализации проекта реабилитации каскада прудов (заказчик - ДПиООС, подрядчик - ООО Техстрой) 
    <br>на поляне 4-го Иваньковского пруда построены две спортивные площадки - для волейбола и баскетбола.
    <br>В настоящее время площадки демонтируются.
    <br>Прошу сообщить нормативный срок использования данной инфраструктуры.
    `,
    component: 'copyButtonGlavControl'},
