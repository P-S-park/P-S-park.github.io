      ...
      >
        <v-row class="text-left">
            ...
            <v-card>
              ...
              <v-card-text>
                <ul>
                  <li>
                    НЗЖ (Нам Здесь Жить)
                    <a href="https://youtu.be/Z_X93mfAnGo">
                      Как «собянинщина» «благоустраивает» ООПТ Москвы? | Парк «Покровское-Стрешнево»
                    </a>
                  </li>
                  <li>MSK1.ru
          ...
          <v-col cols="12" sm="6">
            <v-card class="mb-4">
              <v-card-title>
                Война и Мiръ в «Покровском-Стрешневе»
              </v-card-title>
              <v-card-text>
                Жители создали фильм, <a href="https://youtube.com/playlist?list=PLhdJDo6vgwsH7cbBDxfh-7X963TxGHUox">документальный сериал</a>
                о нашем парке и усадьбе: 
