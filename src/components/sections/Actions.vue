...
const letters = [
  ...
  // },
  {
    ...
    html: `На склоне около родников бурят скважины. Это представляет опасность прочности склона. Работы бесконтрольны, не получено разрешение на строительство, не проведена экспертиза.
    <p>
