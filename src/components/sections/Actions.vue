          ...
          <v-card-text>
            ...
            <v-row>
              ...
              <v-col cols="12" sm="6" md="3">
                ...
                <p>
                  Мы считаем, что нельзя бросать в беде наших людей, обычных жителей, которые искренне переживают за наш парк. К сожалению, в сегодняшней реальности право несимметрично. По всем нашим заявлениям в ОВД, включая заявления об уголовных делах, участковый оформляет отказ, а вот обращения от Генстроя принимает и даже оформляет как якобы выявленное полицией при патрулировании.
                </p>
              </v-col>
              <v-col cols="12" sm="6" md="3">
                <h3>Победим вместе</h3>
                <p>
                  Пусть профессиональный адвокат отработает это дело так,
                  чтобы участковый упарился бегать с доказательствами.
                  Пусть дело развалится в суде.
                </p>
                <p>
