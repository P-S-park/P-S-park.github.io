export default [
    ...
    },
    {
      ...
      html: `
      <ul>
        <li>Травмоопасность новых конструкций на детских площадках.</li>
        <li>Угроза падения деревьев.</li>
        <li>Резкий хим. запах материалов, примененных на детских площадках.</li>
        <li>Сан-эпидем обстановка после изменений, которым подвергся парк.</li>
      </ul>
      <p style="hyphens: auto">
        Адресаты: глав. сан. врач Москвы через эл. приемную Рос. Потреб. Надзора;
        прокуратура, мэрия Москвы, префект СЗАО, главы управ.
      </p>
      <p style="hyphens: auto">
        <a href="https://disk.yandex.ru/i/95oqh5Dy318Z4w">Письмо</a> в РосПотребнадзор (сокращенный до 4000 символов текст)
        <br>
        <a href="https://disk.yandex.ru/i/6W9Iih4K3EREIw">Письмо</a> в остальные инстанции
        <br>
        <a href="https://disk.yandex.ru/i/JC-nYWtUSSk88w">Приложения</a> к письмам.
      </p>`,
      hash: 'b99de0a100431', // for LS/Cookies: Math.random().toString(16).substring(2)
    },
    {
